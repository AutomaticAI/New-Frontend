<template>
    <div class="flex flex-col min-h-screen text-slate-300">
        <header class="px-3 py-6 text-center">
            <h1 class="text-3xl font-black text-white/80 drop-shadow-md">AutoAI Chatbot</h1>
        </header>
        <main class="flex flex-grow px-3 py-2">
            <Chat/>
        </main>
        <footer class="px-3 py-6 text-center">
            <span class="text-xs font-light text-slate-400">powered by <a href="https://autoai.site" target="_blank">AutoAI</a></span>
        </footer>
    </div>
</template>
